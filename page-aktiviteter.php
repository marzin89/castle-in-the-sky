...
<section id="activities">
    ...
    <div class="activity-left">
        <h2 class="h2-activities"><?php /* Skriv ut rubriken */ the_title(); ?></h2>
        <article>
            <?php
    ...
    <?php
        ...
        hamnar till vänster */
        if ( count_posts( 'Aktiviteter' ) < 5 && $count == ( count_posts( 'Aktiviteter' ) - 1 ) ) {
            echo '</div>';
        // Stängningstagg efter det sista inlägget om fler än fem inlägg finns
        } elseif ( count_posts( 'Aktiviteter' ) >= 5 && $count == 4 ) {
            echo '</div>';
        }
    } elseif ( $count % 2 ) {
        // Hämta inlägget
